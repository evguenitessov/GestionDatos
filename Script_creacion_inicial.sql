...
CREATE PROCEDURE [UN_CORTADO].[CANCELAR_RANGO_FECHA] (@FECHA_SISTEMA DATE,@ESPECIALIDAD_MEDICO int,@FECHA_DESDE DATE,@FECHA_HASTA DATE) AS
BEGIN
	DECLARE @FECHA_AUX DATE
...
CREATE PROCEDURE [UN_CORTADO].[CANCELAR_UN_DIA] (@FECHA_SISTEMA DATE,@ESPECIALIDAD_MEDICO int,@FECHA_CAN DATE) AS
BEGIN
	DECLARE @FECHA_AUX2 DATE
	SET @FECHA_AUX2= DATEADD(DAY,1,@FECHA_SISTEMA)
